...
import shop.realgreatcode.rgcblog.core.exception.ssr.Exception403;
import shop.realgreatcode.rgcblog.dto.user.UserRequest;
import shop.realgreatcode.rgcblog.model.user.User;
import shop.realgreatcode.rgcblog.service.UserService;
...
public class UserController {
    ...
    @PostMapping("/join")
    public String join(UserRequest.JoinInDTO joinInDTO, Errors errors){ // x-www-urlencoded
        // username 검증!!!
